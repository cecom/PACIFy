...
/**
 * This is the global Logger factory class. It's only public method is {@link Log#get()}, which returns a suitable
 * logger for the calling class. The
 * returned {@link Logger} instance is decided upon the {@link Loggable} annotation definition in the declaration of the
 * caller class.
 * <p>
 * For inifinite recursion problems, this class have to call the {@link Logger} instance directly for logging purposes
 * 
...
public class Log {
     ...
     * <p>
     * If the caller class has not been marked with the {@link Loggable} annotation, then a the result of
     * {@link Logger#getRootLogger()} will be
     * returned. If the {@link Loggable} annotation has been used, it will
     * return a {@link Logger} that is coherent with the parameter returned by {@link Loggable#clazz()}
     * 
    ...
    /**
     * Given a {@link Loggable} annotation, returns a suitable {@link Logger} given its parameters.
     * <p>
