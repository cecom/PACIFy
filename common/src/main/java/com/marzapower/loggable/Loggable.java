 ...
 * capabilities. You can force a class to log using a specific {@link Class} type {@link Logger}, or you can let the
 * class use its default {@link Logger}.
 * <p>
...
public @interface Loggable {
    ...
    /**
     * This parameter defines the {@link Class} to be passed to the {@link Logger#getLogger(Class)} method. It is
     * overridden by the {@link #loggerName()} parameter, if present.
     */
    ...
    /**
     * This parameter defines the default log level required for logging. If {@link LogLevel#LOG4J} is passed, the class
     * will log with the default log
     * level configuration of log4j.
     */
    LogLevel logLevel() default LogLevel.LOG4J;

    /**
     * This is the collection of the available custom log levels for the {@link Loggable} annotation
     * 
     * @author Daniele Di Bernardo
     * @version 1.2.0
     * 
